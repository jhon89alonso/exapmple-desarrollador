...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('external_contents', function (Blueprint $table) {
            $table->engine= 'MyISAM';
            $table->id();
            $table->integer('content_section',100)->comment('1:home,2:about,3:services,4:portfolio,5:blog,6:contact');
            ...
            $table->tinyInteger('content_colums')->default(12)->nullable()->comment('numero de columnas que tendra el contenido en un contenedor en contenido simple son 12');
            ...
            $table->boolean('coontent_show_title')->default(0)->nullable()->comment('mostrar titulo del contenido');
