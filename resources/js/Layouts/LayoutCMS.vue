...
const showAsideBar = ref(false);
const hijoRef = ref(null);

const openAsideBarLayout = () => {
    showAsideBar.value = true;
    if (showAsideBar.value) {
        // Llama al método openAsideBar del componente hijo
