<!-- component -->
<template>
    <header class="bg-white shadow-lg h-24 hidden md:flex sticky top-0">
        <a
            href=""
            ...
            <ul class="flex items-center ml-4 xl:ml-8 mr-auto">
                ...
                <!-- <li class="p-3 xl:p-6">
                    <a href="" class="flex items-center">
                        <span>Pages</span>
                        <svg
                            class="h-3 opacity-30 ml-2 svg-inline--fa fa-chevron-down fa-w-14 fa-7x"
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="far"
        ...
        <nav class="hidden xl:contents">
            <ul class="flex items-center mr-4 lg:mr-6 xl:mr-8">
                ...
                <li class="p-1">
                    ...
                    >
                        <svg
                            class="h-4 svg-inline--fa fa-linkedin-in fa-w-14 fa-9x"
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fab"
                ...
                <li class="p-1">
                    ...
                    >
                        <svg
                            class="h-4 svg-inline--fa fa-instagram fa-w-14 fa-9x"
                            aria-hidden="true"
                            focusable="false"
                            data-prefix="fab"
                            data-icon="instagram"
